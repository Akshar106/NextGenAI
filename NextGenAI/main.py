...
def displayPDF(uploaded_file):
    """Display the uploaded PDF in a Streamlit app with zoom."""
    try:
        bytes_data = uploaded_file.getvalue()
        base64_pdf = base64.b64encode(bytes_data).decode('utf-8')
        pdf_display = f'<iframe src="data:application/pdf;base64,{base64_pdf}#zoom=350" width="700" height="400" type="application/pdf"></iframe>'
